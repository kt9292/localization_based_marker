...
def find_aruco_duplicated(frame, marker_size=6, total_markers=250, draw=True):
...
# file load
file_path = "./sample/UDnet/aruco/output"
file_list = os.listdir(file_path)
imgs_path = []
output_path = "./result/UDnet/aruco"
...
for i in imgs_path:
    ...
    output_name = f'{output_name}_result.jpg'
